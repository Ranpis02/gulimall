  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('product:category:delete')" :disabled="dataListSelections.length <= 0" type="danger"
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button size="small" type="text" @click="addOrUpdateHandle(scope.row.catId)">修改</el-button>
          <el-button size="small" type="text" @click="deleteHandle(scope.row.catId)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
