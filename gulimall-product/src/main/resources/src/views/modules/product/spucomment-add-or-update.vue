  ...
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="评论图片/视频[json数据；[{type:文件类型,url:资源路径}]]" prop="resources">
        <el-input v-model="dataForm.resources"
                  placeholder="评论图片/视频[json数据；[{type:文件类型,url:资源路径}]]"></el-input>
      </el-form-item>
      ...
      <el-form-item label="评论类型[0 - 对商品的直接评论，1 - 对评论的回复]" prop="commentType">
        <el-input v-model="dataForm.commentType"
                  placeholder="评论类型[0 - 对商品的直接评论，1 - 对评论的回复]"></el-input>
      </el-form-item>
    </el-form>
